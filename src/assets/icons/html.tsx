...
export const HtmlIcon = ({ className }: SvgProps) => (
    <svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enable-background="new 0 0 512 512" className={className}>
